...
function border() {
  ...
  var imgcanvas = document.getElementById("foreground"); frameimage.drawTo(imgcanvas);
}
...
function rainbow() {
 ...
 var imgcanvas = document.getElementById("foreground"); rainbowimage.drawTo(imgcanvas);
